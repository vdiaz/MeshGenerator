// generated 2007/5/4 18:04:34 CLT by chupacabrasx@amd64-3000.(none)
...
{  GUIDialogNuevaMalla = this;
   ...
   comboTipoFigura = Gtk::manage(new class Gtk::ComboBoxText());
   ...
   label12->set_selectable(false);
   {
      ...
      if (generarMalla.getType() == Setting::TypeGroup)
      {
         ...
         if (cilindro)
            comboTipoFigura->append("Cilindro");

         if (medula)
            comboTipoFigura->append("A partir de Medula");
      }
   }
   ...
   comboTipoFigura->signal_changed().connect(sigc::mem_fun(*this, &GUIDialogNuevaMalla_glade::on_combo_entryTipoFigura_changed), false);
