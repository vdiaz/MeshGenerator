// generated 2007/5/11 15:38:22 CLT by chupacabrasx@amd64-3000.(none)
...
{  GUIVentanaPrincipal = this;
   ...
   Setting & treeGrowth = cfg_reader->getTreeGrowth();
   Setting & generarMalla = cfg_reader->getGenerarMalla();
   Setting & mejorarMalla = cfg_reader->getMejorarMalla();
   Setting & refinarMalla = cfg_reader->getRefinarMalla();
   Setting & desrefinarMalla = cfg_reader->getDesrefinarMalla();
   Setting & distribHormona = cfg_reader->getDistribuirHormona();
   ...
   Gtk::Image *toolbuttonDistribuir_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-execute"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolbuttonDistribuir = Gtk::manage(new class Gtk::ToolButton(*toolbuttonDistribuir_img, "Distribuir hormona"));
#endif //
   ...
   toolbuttonMejorar = Gtk::manage(new class Gtk::ToolButton(*toolbuttonMejorar_img, "Mejorar"));
    ...
    Gtk::Image *toolbuttonInformacion_img = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-info"), Gtk::IconSize(3)));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolbuttonInformacion = Gtk::manage(new class Gtk::ToolButton(*toolbuttonInformacion_img, "Información"));
#endif //
...
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   if (distribHormona.getType() == Setting::TypeBoolean && distribHormona)
      toolbar1->append(*toolbuttonDistribuir);
#else //
   if (distribHormona.getType() == Setting::TypeBoolean && distribHormona)
   {
      toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Distribuir hormona", *toolbuttonDistribuir_img, Gtk::Toolbar_Helpers::Callback0()));
      toolbuttonDistribuir = static_cast<Gtk::Button *>(toolbar1->tools().back().get_widget());
   }
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
...
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   if (mejorarMalla.getType() == Setting::TypeBoolean && mejorarMalla)
...
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
    toolbar1->append(*toolbuttonInformacion);
#else //
    toolbar1->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Información", *toolbuttonInformacion_img, Gtk::Toolbar_Helpers::Callback0()));
    toolbuttonInformacion = static_cast<Gtk::Button *>(toolbar1->tools().back().get_widget());
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
...
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolbuttonDistribuir->set_visible_horizontal(true);
   toolbuttonDistribuir->set_visible_vertical(true);
   toolbuttonDistribuir->set_is_important(false);
#endif //
   toolbuttonDistribuir_img->show();
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolbuttonInformacion->set_visible_horizontal(true);
   toolbuttonInformacion->set_visible_vertical(true);
   toolbuttonInformacion->set_is_important(false);
#endif //
   toolbuttonInformacion_img->show();
   ...
   if (treeGrowth.getType() == Setting::TypeBoolean && treeGrowth)
      ...
      GUIVentanaPrincipal->set_title("Generador de mallas");
   ...
   toolbuttonDistribuir->signal_clicked().connect(sigc::mem_fun(*this, &GUIVentanaPrincipal_glade::on_distribuir_hormona1_activate), false);
   ...
   toolbuttonInformacion->signal_clicked().connect(sigc::mem_fun(*this, &GUIVentanaPrincipal_glade::on_informacion1_activate), false);
